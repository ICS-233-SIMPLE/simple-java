...
public class ApplicationFormViewImpl extends JFrame implements ApplicationFormView {
    ...
    public ApplicationFormViewImpl() {
        ...
        passportOfficeComboBox.setPreferredSize(new Dimension(153, getPassportOfficeComboBox().getPreferredSize().height));
    ...
    private JPanel createPersonalDetailsPanel() {
        ...
        selfDeclaration.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED), "Self-Declaration"));
        ...
        place(new JLabel("I owe allegiance to the sovereignty, unity & integrity of India, and have not voluntarily acquired citizenship or travel document of any"), selfDeclaration,0,0,true);
        gbc.insets = new Insets(0,50,5,50);
        place(new JLabel("other country. I have not lost, surrendered or been deprived of the citizenship of India. I have not contravened any of the conditions"), selfDeclaration,1,0,true);
        place(new JLabel("relating to the possession and use of an Indian passport."), selfDeclaration,2,0,true);
        place(new JLabel("I affirm that the information and particulars given by me in this form are true and correct. I further state that I am not suppressing any"), selfDeclaration,3,0,true);
        place(new JLabel("material information in this regard. I further affirm that the enclosures and documentary proof submitted in support of my application for"), selfDeclaration,4,0,true);
        place(new JLabel("an Indian passport are authentic and solely pertain to me and I am fully responsible for the accuracy of the same. I am liable to be"), selfDeclaration,5,0,true);
        place(new JLabel("penalized or prosecuted if found otherwise. I am aware that under the Passports Act, 1967 it is a criminal offence to furnish any false"), selfDeclaration,6,0,true);
        place(new JLabel("information or to suppress any material information with a view to obtaining passport or travel document."), selfDeclaration,7,0,true);
        place(new JLabel("I have read and understood the contents of the above and by submitting this form certify that all the information submitted by me in the"), selfDeclaration,8,0,true);
    ...
    private JPanel createPaymentPanel() {
        ...
        JLabel payWarning1 = new JLabel("Payment once made for availing passport services will not be refunded.", SwingConstants.LEFT);
        JLabel payWarning2 = new JLabel("If the payment is successfully done, please do not pay again.", SwingConstants.LEFT);
